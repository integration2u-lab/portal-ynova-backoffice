  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 px-4 py-6">
      <div className="flex max-h-[90vh] w-full max-w-4xl flex-col overflow-hidden rounded-2xl bg-white shadow-2xl dark:bg-slate-950">
        <div className="border-b border-slate-200 bg-gradient-to-br from-white to-gray-50 dark:border-slate-800 dark:from-slate-950 dark:to-slate-900">
          <div className="flex items-start justify-between px-6 py-5">
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2">
                <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-yn-orange/10">
                  <PencilLine className="h-5 w-5 text-yn-orange" />
                </div>
                <div>
                  ...
                  <p className="mt-1 text-sm font-semibold text-slate-600 dark:text-slate-400">
                    {contract.cliente} · CNPJ {contract.cnpj}
                  </p>
                  {contract.segmento && (
                    <p className="mt-1 text-xs text-slate-500 dark:text-slate-500">
                      Segmento: {contract.segmento}
                      {contract.fornecedor && ` · Fornecedor: ${contract.fornecedor}`}
                    </p>
                  )}
                </div>
              </div>
          ...
          <div className="px-6 pb-4">
            <p className="text-xs font-semibold text-yn-orange dark:text-yn-orange/90">
              <PencilLine className="inline h-3 w-3 mr-1" />
              Modo de edição · Preencha os campos e clique em "Salvar alterações"
            </p>
          </div>
        </div>
