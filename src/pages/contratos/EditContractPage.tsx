  ...
  return (
    <div className="space-y-6 p-4">
      ...
      <div className="rounded-xl border border-gray-200 bg-gradient-to-br from-white to-gray-50 shadow-sm">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            <div className="flex-1">
              <div className="flex items-start gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-yn-orange/10 flex-shrink-0">
        ...
        <div className="px-6 py-3 bg-yn-orange/5 border-t border-yn-orange/10">
          <p className="text-xs font-semibold text-yn-orange">
            <PencilLine className="inline h-3 w-3 mr-1" />
            Modo de edição ativo · As alterações serão salvas automaticamente
          </p>
        </div>
      </div>
